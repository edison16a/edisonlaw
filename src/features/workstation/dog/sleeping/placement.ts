...
/** Where the dog sleeps in the work scene (see DOG_NAP in layout.ts). */
export const SLEEPING_PLACEMENT: DogPlacement = { position: DOG_NAP.position, rotationY: DOG_NAP.rotationY };
