...
interface StageSurfaceProps {
  ...
  /** True while the stage fills the viewport. Touch drags then spin the spiral instead of scrolling the page. */
  home: boolean;
  children: ReactNode;
}
 ...
 */
export function StageSurface({ ref, home, children }: StageSurfaceProps) {
