...
/** Identical small card: black face, thin grey border, white mark and the name. */
export function SkillCard({ name }: { name: string }) {
  ...
  return (
    ...
    >
      <span className="flex size-5 shrink-0 items-center justify-center text-white opacity-90 transition-opacity group-hover:opacity-100">
        {icon?.kind === 'brand' && (
